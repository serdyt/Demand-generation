...
file_name = '/home/ai6644/Malmo/Tools/Demand generation/data/distance_matix_municipalities.csv'
points = []
...
# Save the result
matrixCsv.save('/home/ai6644/Malmo/Tools/SyntheticPopulation/data/time_distance_matrix_otp.csv')
